 ...
 * @property {{x: number, y: number}|null} movementTarget - Target coordinates for movement.
...
// We can export the typedef for JSDoc reference elsewhere, but no runtime code needed here.
// export {}; 